      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center space-y-6 text-center mb-12 lg:mb-20">
          ...
          <p className="max-w-[800px] text-foreground/80 md:text-xl">
            QTeaCake is more than just an app; it's a movement to connect authentic tea purveyors with a passionate community, turning 'tea deserts' into thriving oases.
          </p>
        </div>

        <div className="grid gap-12 lg:grid-cols-5 lg:gap-16 items-center mb-16 lg:mb-24">
          <div className="lg:col-span-3 space-y-4">
            <h2 className="font-headline text-3xl font-bold text-primary">Our Origin Story</h2>
            <p className="text-foreground/80 md:text-lg">
              The journey to QTeaCake began with a personal quest for mindfulness and a healthier lifestyle, found in the simple ritual of brewing tea. This daily practice brought immense joy and lowered stress, but a significant hurdle remained: living in a 'tea desert.'
            </p>
            <p className="text-foreground/80 md:text-lg">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <Card className="flex flex-col p-6 bg-card border-primary/10">
          ...
          <Card className="flex flex-col p-6 bg-card border-secondary shadow-secondary/20 shadow-lg">
            <CardHeader className="p-0 mb-4">
              <div className="bg-secondary/10 p-3 rounded-lg w-fit mb-4">
                <Icons.solution className="h-8 w-8 text-secondary" />
              </div>
              <CardTitle className="font-headline text-2xl">Our Solution</CardTitle>
            </CardHeader>
            <CardContent className="p-0 flex-grow">
               <p className="text-muted-foreground">
                QTeaCake is a discovery platform that intelligently maps authentic tea shops. We empower users to find nearby gems, filter by specific offerings, and receive AI-powered recommendations, bridging the gap between hobbyists and vendors.
              </p>
            </CardContent>
          </Card>
          <Card className="flex flex-col p-6 bg-card border-primary/10">
